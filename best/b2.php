  ...
  window.onclick = function (event) {
    ...
    <div class="container">
        <div class="image-gallery">
            <img src="b/b2.1.jpeg" alt="Thumbnail 1" onclick="showImage(0)">
            <img src="b/b2.2.jpeg" alt="Thumbnail 2" onclick="showImage(1)">
        </div>
        <div class="main-image">
            <button class="nav-arrow left" onclick="prevImage()">❮</button>
            <img id="mainImage" src="b/b2.1.jpeg" alt="Main Image">
    ...
    <div class="details">
        <h2>상세이미지</h2>
        <img src="b/b2.1.jpeg" alt="Detail 1">
        <img src="b/b2.2.jpeg" alt="Detail 2">
