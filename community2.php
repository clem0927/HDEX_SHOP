...
<html lang="en">
  ...
  <ul class="mypage-nav" style="border-bottom:2px solid black;padding-bottom:1vh ">
    ...
    <li><a href="community.php" >리뷰목록</a></li>
    <li><a href="community2.php" style="font-weight:bold">리뷰작성</a></li>
    <li style="margin-left:auto"></li>
  </ul>
    <div class="mypage-main" style="height:100vh; ">
    <div class="main-in"> 
      <!--리뷰작성-->
      <form action="community2proc.php" method="post"
      ...
      <div>
        <input type="text" name="uid" value="<?=$uid?>" readonly class="inp">
      </div>
      <div >
        <label for="lname">작성일</label>
      </div>
      <div>
        <input type="text" name="wdate" value="<?=$wdate?>" readonly class="inp">
      </div>
      <div >
      ...
      <div >
        <label for="lname">한줄평</label>
      </div>
      <div >
      <input type="text" name="note" placeholder="한줄평" class="inp">
      </div>
      <h2>평점</h2>
      <div>
      ...
      <hr>
      <p></p>
      <input type="submit" value="작성하기" class="submit" style="background-color:black;color:white;height:5vh;width:50%">
      </div>
      </form>
    </div>
  </div>
