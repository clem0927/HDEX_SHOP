  ...
  window.onclick = function (event) {
    ...
    <div class="container">
        <div class="image-gallery">
            <img src="m/m4.1.jpeg" alt="Thumbnail 1" onclick="showImage(0)">
            <img src="m/m4.2.jpeg" alt="Thumbnail 2" onclick="showImage(1)">
            <img src="m/m4.3.jpeg" alt="Thumbnail 3" onclick="showImage(2)">
            <img src="m/m4.4.jpeg" alt="Thumbnail 4" onclick="showImage(3)">
        </div>
        <div class="main-image">
            <button class="nav-arrow left" onclick="prevImage()">❮</button>
            <img id="mainImage" src="m/m4.1.jpeg" alt="Main Image">
            <button class="nav-arrow right" onclick="nextImage()">❯</button>
        </div>
        <div class="product-info" style="background-color: lightgray;padding-left:1vw;padding-bottom:2vh;font-weight:bold">
        <form action="../addcartproc.php" method="get">
          ...
          <input type="submit" value="장바구니 담기" class="sub" style="background-color:lightgreen;color:black;cursor:pointer;width:80%;border:2px solid gray;height:40px;font-weight:bold" />
        </form>
      </div>
    </div>
    ...
    <div class="details">
        <h2>상세이미지</h2>
        <img src="m/m4.1.jpeg" alt="Detail 1">
        <img src="m/m4.2.jpeg" alt="Detail 2">
        <img src="m/m4.3.jpeg" alt="Detail 3">
        <img src="m/m4.4.jpeg" alt="Detail 4">
