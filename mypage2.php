...
<html lang="en">
  ...
  <ul class="mypage-nav" style="border-bottom:2px solid black;padding-bottom:1vh ">
    ...
    <li><a href="mypage2.php" style="font-weight:bold">정보변경</a></li>
    ...
    <div class="main-in">
      <h2>회원정보 변경</h2>
      <form action="signmodproc.php" method="get" class="change-form">
          <div>아이디</div>
          <p><input type="text" value="<?=$uid?>" name="uid" readonly></p>
          <div>비밀번호</div>
          <p><input type="password" placeholder="비밀번호*" name="pwd"></p>
          <div>이메일</div>
          <p><input type="text" value="<?=$email?>" placeholder="이메일*"name="email"></p>
          <div>성함</div>
          <p><input type="text" value="<?=$name?>"
          placeholder="성함*" name="name"></p>
          <div>연락처</div>
          <p><input type="text" value="<?=$telno?>"
          placeholder="전화번호*" name="telno"></p>
          <br>
          <input type="submit" value="수정하기" class="submit" style="background-color:black;color:white;height:5vh;width:50%">
          <p></p>
          <input type="button" class="submit" value="탈퇴하기"style="background-color:black;color:white;height:5vh;width:50%" onclick="location.href='signdel.php';">
      </form>
    </div>
  </div>
  <div class="footer">
