  ...
  window.onclick = function (event) {
    ...
    <div class="container">
        <div class="image-gallery">
            <img src="w/w3.1.jpeg" alt="Thumbnail 1" onclick="showImage(0)">
            <img src="w/w3.2.jpeg" alt="Thumbnail 2" onclick="showImage(1)">
            <img src="w/w3.3.jpeg" alt="Thumbnail 2" onclick="showImage(2)">
            <img src="w/w3.4.jpeg" alt="Thumbnail 2" onclick="showImage(3)">
        </div>
        <div class="main-image">
            <button class="nav-arrow left" onclick="prevImage()">❮</button>
            <img id="mainImage" src="w/w3.1.jpeg" alt="Main Image">
    ...
    <div class="details">
        <h2>상세이미지</h2>
        <img src="w/w3.1.jpeg" alt="Detail 1">
        <img src="w/w3.2.jpeg" alt="Detail 2">
        <img src="w/w3.3.jpeg" alt="Detail 2">
        <img src="w/w3.4.jpeg" alt="Detail 2">
