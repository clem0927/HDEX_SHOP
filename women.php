...
<?php
  ...
  window.onclick = function (event) {
    ...
    <div class="category-tabs">
      <a href="#shirts" class="active">상의</a>
      <a href="#pants">하의</a>
      <a href="#accessories">신발</a>
    </div>
    <div class="content">
      <div class="title-section" id="shirts">
        <h2>상의</h2>
      </div>
    ...
    if($result && $result->num_rows>0){
      for($i=0;$i<4;$i++){
        ...
        <a href="women/w<?=$row['id']?>.php?isLogged=<?=$isLogged?>&name=<?=$row['name']?>&price=<?=$row['price']?>&photo=<?=$row['photo']?>">
        <div class="product-item">
          <img src="women/w/<?=$row['photo']?>" alt="상품 이미지 1" />
          <p><?=$row['name']?> </p>
      ...
      <div class="title-section" id="pants" style="margin-top: 80px">
        <h2>하의</h2>
      </div>
      ...
      <div class="title-section" id="accessories" style="margin-top: 80px">
        <h2>신발</h2>
      </div>
